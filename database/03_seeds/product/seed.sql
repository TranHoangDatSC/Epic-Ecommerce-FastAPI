...
(3, 1, 'Laptop cũ Dell Inspiron 15', 'Laptop Dell Inspiron 15 đã qua sử dụng, cấu hình Core i5, RAM 8GB, SSD 256GB, màn hình 15.6 inch. Còn bảo hành 6 tháng.', 8500000.00, 3, 2200, '35x24x2 cm', 8, 6, 1),
(3, 1, 'iPhone 12 Pro Max 256GB', 'iPhone 12 Pro Max màu xanh, dung lượng 256GB, kèm sạc và cáp. Máy còn mới 95%, không trầy xước.', 18500000.00, 1, 228, '16x7.8x0.7 cm', 9, 12, 1),
