...
('mod1', 'mod1@gmail.com', crypt('mod123', gen_salt('bf', 8)), encode(gen_random_bytes(32), 'hex'), 'Trần Kim Lộc', '0912345678', '45 Nguyễn Huệ, Q.1, TP.HCM', TRUE, NULL, '/media/users/user_2_mod1.png'),
