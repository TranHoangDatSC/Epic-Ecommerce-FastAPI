...
class User(Base):
    ...
    balance = Column(DECIMAL(18, 4), default=10000000.00)
...
class Transaction(Base):
    ...
    fraud_score = Column(DECIMAL(5, 2), default=0.0, nullable=True)
    provider_transaction_id = Column(String(100), nullable=True) 

    transaction_status = Column(SmallInteger, default=0)  # 0: Pending, 1: Success, 2: Flagged, 3: Failed
