...
class UserBase(BaseModel):
    ...
    balance: Decimal = Field(default=10000000.00)
...
class TransactionBase(BaseModel):
    ...
    # Dữ liệu tài chính cho Fraud Detection
    balance_before: Decimal = Field(default=0.0) # oldbalanceOrg
    balance_after: Decimal = Field(default=0.0)  # newbalanceOrig
...
class TransactionResponse(TransactionBase):
    ...
    user_id: int
    payment_method_id: int
    transaction_status: int  # 0: Pending, 1: Success, 2: Flagged, 3: Fraud, 4: Failed
    created_at: datetime
